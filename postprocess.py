...
def is_slot_da(da):
    tag_da = {'Inform', 'Select', 'Recommend', 'NoOffer', 'NoBook', 'OfferBook', 'OfferBooked', 'Book','Find','Reserve','Play','Get','Buy','Lookup','Search','Schedule','Check','Transfer','Add','Rent','Make','Request','Share','N'}
